...
Vtx My_map_Scene_Room_0_Room_0_Mesh_My_map_Scene_Room_0_Material_mesh_vtx[] = {
    {{ { 327, 0, -327 }, 0, { 0, 32 }, { 0x0, 0x0, 0x7F, 255 } }},
    {{ { 981, 0, -327 }, 0, { 0, 32 }, { 0x0, 0x0, 0x7F, 255 } }},
    {{ { 981, 0, -981 }, 0, { 0, 32 }, { 0x0, 0x0, 0x7F, 255 } }},
    {{ { 327, 0, -981 }, 0, { 0, 32 }, { 0x0, 0x0, 0x7F, 255 } }},
    {{ { -327, 0, -327 }, 0, { 0, 32 }, { 0x0, 0x0, 0x7F, 255 } }},
    {{ { -327, 0, -981 }, 0, { 0, 32 }, { 0x0, 0x0, 0x7F, 255 } }},
    {{ { -981, 0, -327 }, 0, { 0, 32 }, { 0x0, 0x0, 0x7F, 255 } }},
    {{ { -981, 0, -981 }, 0, { 0, 32 }, { 0x0, 0x0, 0x7F, 255 } }},
...
Gfx My_map_Scene_Room_0_Room_0_Mesh_My_map_Scene_Room_0_Material_mesh_dl[] = {
    gsSPVertex(&My_map_Scene_Room_0_Room_0_Mesh_My_map_Scene_Room_0_Material_mesh_vtx[0], 22, 0),
...
// Hi from write_mesh_info_to_f3d_c
Gfx My_map_Scene_Room_0_nightclub_My_map_Scene_Room_0_Material_002_mat_dl[] = {
    gsDPPipeSync(),
    gsDPSetOtherMode(
        G_PM_NPRIMITIVE
      | G_CYC_2CYCLE
...
Vtx My_map_Scene_Room_0_nightclub_My_map_Scene_Room_0_Material_002_mesh_vtx[] = {
    {{ { 582, 0, -185 }, 0, { 32, 16 }, { 0x37, 0x72, 0x0, 255 } }},
    {{ { 582, 200, -185 }, 0, { 32, 0 }, { 0x37, 0x72, 0x0, 255 } }},
    {{ { 795, 200, -83 }, 0, { 27, 0 }, { 0x37, 0x72, 0x0, 255 } }},
    {{ { 795, 0, -83 }, 0, { 27, 16 }, { 0x37, 0x72, 0x0, 255 } }},
    {{ { 795, 0, -83 }, 0, { 27, 16 }, { 0x7B, 0x1C, 0x0, 255 } }},
    {{ { 795, 200, -83 }, 0, { 27, 0 }, { 0x7B, 0x1C, 0x0, 255 } }},
    {{ { 847, 200, 146 }, 0, { 22, 0 }, { 0x7B, 0x1C, 0x0, 255 } }},
    {{ { 847, 0, 146 }, 0, { 22, 16 }, { 0x7B, 0x1C, 0x0, 255 } }},
    {{ { 847, 0, 146 }, 0, { 22, 16 }, { 0x63, 0xB1, 0x0, 255 } }},
    {{ { 847, 200, 146 }, 0, { 22, 0 }, { 0x63, 0xB1, 0x0, 255 } }},
    {{ { 700, 200, 330 }, 0, { 18, 0 }, { 0x63, 0xB1, 0x0, 255 } }},
    {{ { 700, 0, 330 }, 0, { 18, 16 }, { 0x63, 0xB1, 0x0, 255 } }},
    {{ { 700, 0, 330 }, 0, { 18, 16 }, { 0x0, 0x81, 0x0, 255 } }},
    {{ { 700, 200, 330 }, 0, { 18, 0 }, { 0x0, 0x81, 0x0, 255 } }},
    {{ { 464, 200, 330 }, 0, { 13, 0 }, { 0x0, 0x81, 0x0, 255 } }},
    {{ { 464, 0, 330 }, 0, { 13, 16 }, { 0x0, 0x81, 0x0, 255 } }},
    {{ { 464, 0, 330 }, 0, { 13, 16 }, { 0x9D, 0xB1, 0x0, 255 } }},
    {{ { 464, 200, 330 }, 0, { 13, 0 }, { 0x9D, 0xB1, 0x0, 255 } }},
    {{ { 317, 200, 146 }, 0, { 9, 0 }, { 0x9D, 0xB1, 0x0, 255 } }},
    {{ { 317, 0, 146 }, 0, { 9, 16 }, { 0x9D, 0xB1, 0x0, 255 } }},
    {{ { 317, 0, 146 }, 0, { 9, 16 }, { 0x85, 0x1C, 0x0, 255 } }},
    {{ { 317, 200, 146 }, 0, { 9, 0 }, { 0x85, 0x1C, 0x0, 255 } }},
    {{ { 370, 200, -83 }, 0, { 4, 0 }, { 0x85, 0x1C, 0x0, 255 } }},
    {{ { 370, 0, -83 }, 0, { 4, 16 }, { 0x85, 0x1C, 0x0, 255 } }},
    {{ { 370, 0, -83 }, 0, { 4, 16 }, { 0xC9, 0x72, 0x0, 255 } }},
    {{ { 370, 200, -83 }, 0, { 4, 0 }, { 0xC9, 0x72, 0x0, 255 } }},
    {{ { 582, 200, -185 }, 0, { 0, 0 }, { 0xC9, 0x72, 0x0, 255 } }},
    {{ { 582, 0, -185 }, 0, { 0, 16 }, { 0xC9, 0x72, 0x0, 255 } }},
};
Gfx My_map_Scene_Room_0_nightclub_My_map_Scene_Room_0_Material_002_mesh_dl[] = {
    gsSPVertex(&My_map_Scene_Room_0_nightclub_My_map_Scene_Room_0_Material_002_mesh_vtx[0], 28, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx My_map_Scene_Room_0_nightclub_dl[] = {
    gsSPDisplayList(My_map_Scene_Room_0_nightclub_My_map_Scene_Room_0_Material_002_mat_dl),
    gsSPDisplayList(My_map_Scene_Room_0_nightclub_My_map_Scene_Room_0_Material_002_mesh_dl),
    gsSPEndDisplayList(),
};
RoomShapeDListsEntry my_map_scene_Room_0_DListsEntries[] = {
    ...
    {
        My_map_Scene_Room_0_nightclub_dl,
        NULL,
    },
};
