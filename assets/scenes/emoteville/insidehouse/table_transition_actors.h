...
/*
DEF_TRANSITION_ACTOR(INSIDE_HOUSE_SCENE_ROOM_ROOM_NAME,
                     INSIDE_HOUSE_SCENE_CAMERA_DEFAULT,
                     INSIDE_HOUSE_SCENE_ROOM_ROOM_NAME,
                     INSIDE_HOUSE_SCENE_CAMERA_DEFAULT, ACTOR_EN_DOOR, POS_DOOR0,
                     YAW_DOOR0, ENDOOR_PARAMS_NODATA(DOOR_ROOMLOAD, false))
*/
