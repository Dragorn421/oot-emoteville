...
RomFile inside_house_scene_RoomList[] = {
...
ActorEntry inside_house_scene_PlayerEntryList[] = {
#define DEF_SPAWN(spawnEnumName, roomEnumName, pos, rotY, params)              \
...
EnvLightSettings inside_house_scene_EnvLightSettingsList[] = {
...
enum {
#define DEF_SURFACETYPE(name, st0, st1, flagsA, flagsB)                        \
  INSIDE_HOUSE_SCENE_COL_##name##_FLAGS_A = (flagsA),                            \
  INSIDE_HOUSE_SCENE_COL_##name##_FLAGS_B = (flagsB),
#include "../table_polytypes.h"
#undef DEF_SURFACETYPE
  INSIDE_HOUSE_SCENE_COL_FLAGS_LAST
};

enum {
#define DEF_SURFACETYPE(name, st0, st1, flagsA, flagsB)                        \
  INSIDE_HOUSE_SCENE_SURFACETYPE_##name,
#include "../table_polytypes.h"
#undef DEF_SURFACETYPE
  MY_MAP_SURFACETYPE_MAX
};

SurfaceType inside_house_scene_SurfaceTypes[] = {
#define DEF_SURFACETYPE(name, st0, st1, flagsA, flagsB) {{st0, st1}},
#include "../table_polytypes.h"
#undef DEF_SURFACETYPE
};

BgCamInfo inside_house_scene_BgCamList[] = {
...
TransitionActorEntry inside_house_scene_TransitionActorList[] = {
