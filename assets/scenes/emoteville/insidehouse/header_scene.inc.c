...
SceneCmd inside_house_scene_scene[] = {
    ...
    SCENE_CMD_TRANSITION_ACTOR_LIST(ARRAY_COUNT(inside_house_scene_TransitionActorList), inside_house_scene_TransitionActorList),
    ...
    SCENE_CMD_ENV_LIGHT_SETTINGS(ARRAY_COUNT(inside_house_scene_EnvLightSettingsList), inside_house_scene_EnvLightSettingsList),
    SCENE_CMD_END(),
};
