...
Vtx nightclub_Scene_Room_0_nightclub_nightclub_Scene_Room_0_walls_mesh_vtx[] = {
    ...
    {{ { 401, 378, -303 }, 0, { 27, 0 }, { 0xC9, 0x8E, 0x0, 255 } }},
    {{ { 0, 378, -497 }, 0, { 32, 0 }, { 0xC9, 0x8E, 0x0, 255 } }},
    {{ { 401, 0, -303 }, 0, { 27, 16 }, { 0x85, 0xE4, 0x0, 255 } }},
    {{ { 500, 0, 130 }, 0, { 22, 16 }, { 0x85, 0xE4, 0x0, 255 } }},
    {{ { 500, 378, 130 }, 0, { 22, 0 }, { 0x85, 0xE4, 0x0, 255 } }},
    {{ { 401, 378, -303 }, 0, { 27, 0 }, { 0x85, 0xE4, 0x0, 255 } }},
    {{ { 500, 0, 130 }, 0, { 22, 16 }, { 0x9D, 0x4F, 0x0, 255 } }},
    {{ { 222, 0, 478 }, 0, { 18, 16 }, { 0x9D, 0x4F, 0x0, 255 } }},
    {{ { 222, 378, 478 }, 0, { 18, 0 }, { 0x9D, 0x4F, 0x0, 255 } }},
    {{ { 500, 378, 130 }, 0, { 22, 0 }, { 0x9D, 0x4F, 0x0, 255 } }},
    {{ { 222, 0, 478 }, 0, { 18, 16 }, { 0x0, 0x7F, 0x0, 255 } }},
    {{ { -222, 0, 478 }, 0, { 13, 16 }, { 0x0, 0x7F, 0x0, 255 } }},
    {{ { -222, 378, 478 }, 0, { 13, 0 }, { 0x0, 0x7F, 0x0, 255 } }},
    {{ { 222, 378, 478 }, 0, { 18, 0 }, { 0x0, 0x7F, 0x0, 255 } }},
    {{ { -222, 0, 478 }, 0, { 13, 16 }, { 0x63, 0x4F, 0x0, 255 } }},
    {{ { -500, 0, 130 }, 0, { 9, 16 }, { 0x63, 0x4F, 0x0, 255 } }},
    {{ { -500, 378, 130 }, 0, { 9, 0 }, { 0x63, 0x4F, 0x0, 255 } }},
    {{ { -222, 378, 478 }, 0, { 13, 0 }, { 0x63, 0x4F, 0x0, 255 } }},
    {{ { -500, 0, 130 }, 0, { 9, 16 }, { 0x7B, 0xE4, 0x0, 255 } }},
    {{ { -401, 0, -303 }, 0, { 4, 16 }, { 0x7B, 0xE4, 0x0, 255 } }},
    {{ { -401, 378, -303 }, 0, { 4, 0 }, { 0x7B, 0xE4, 0x0, 255 } }},
    {{ { -500, 378, 130 }, 0, { 9, 0 }, { 0x7B, 0xE4, 0x0, 255 } }},
    {{ { -401, 0, -303 }, 0, { 4, 16 }, { 0x37, 0x8E, 0x0, 255 } }},
    {{ { 0, 0, -497 }, 0, { 0, 16 }, { 0x37, 0x8E, 0x0, 255 } }},
    {{ { 0, 378, -497 }, 0, { 0, 0 }, { 0x37, 0x8E, 0x0, 255 } }},
    {{ { -401, 378, -303 }, 0, { 4, 0 }, { 0x37, 0x8E, 0x0, 255 } }},
};
...
Vtx nightclub_Scene_Room_0_nightclub_nightclub_Scene_Room_0_ceiling_mesh_vtx[] = {
    {{ { 401, 378, -303 }, 0, { 27, 0 }, { 0x0, 0x0, 0x81, 255 } }},
    {{ { 500, 378, 130 }, 0, { 22, 0 }, { 0x0, 0x0, 0x81, 255 } }},
    {{ { 0, 378, 16 }, 0, { 13, 0 }, { 0x0, 0x0, 0x81, 255 } }},
    {{ { 0, 378, -497 }, 0, { 0, 0 }, { 0x0, 0x0, 0x81, 255 } }},
    {{ { -401, 378, -303 }, 0, { 4, 0 }, { 0x0, 0x0, 0x81, 255 } }},
    {{ { 0, 378, 16 }, 0, { 13, 0 }, { 0x0, 0x0, 0x81, 255 } }},
    {{ { 500, 378, 130 }, 0, { 22, 0 }, { 0x0, 0x0, 0x81, 255 } }},
    {{ { 222, 378, 478 }, 0, { 18, 0 }, { 0x0, 0x0, 0x81, 255 } }},
    {{ { -222, 378, 478 }, 0, { 13, 0 }, { 0x0, 0x0, 0x81, 255 } }},
    {{ { -500, 378, 130 }, 0, { 9, 0 }, { 0x0, 0x0, 0x81, 255 } }},
    {{ { -401, 378, -303 }, 0, { 4, 0 }, { 0x0, 0x0, 0x81, 255 } }},
    {{ { -222, 378, 478 }, 0, { 13, 0 }, { 0x0, 0x0, 0x81, 255 } }},
};
