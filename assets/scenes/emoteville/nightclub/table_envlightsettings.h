...
DEF_ENV_LIGHT_SETTINGS(NIGHTCLUB_SCENE_ENV_LIGHT_SETTINGS_0,
                       ENV_LIGHT_SETTINGS_DEFAULT)
DEF_ENV_LIGHT_SETTINGS(NIGHTCLUB_SCENE_ENV_LIGHT_SETTINGS_1,
                       ENV_LIGHT_SETTINGS_DEFAULT)
DEF_ENV_LIGHT_SETTINGS(NIGHTCLUB_SCENE_ENV_LIGHT_SETTINGS_2,
                       ENV_LIGHT_SETTINGS_DEFAULT)
DEF_ENV_LIGHT_SETTINGS(NIGHTCLUB_SCENE_ENV_LIGHT_SETTINGS_3,
                       ENV_LIGHT_SETTINGS_DEFAULT)
