...
RomFile nightclub_scene_RoomList[] = {
...
Spawn nightclub_scene_SpawnList[] = {
#define DEF_SPAWN(spawnEnumName, roomEnumName, pos, rotY, params)              \
...
ActorEntry nightclub_scene_PlayerEntryList[] = {
#define DEF_SPAWN(spawnEnumName, roomEnumName, pos, rotY, params)              \
...
EnvLightSettings nightclub_scene_EnvLightSettingsList[] = {
...
enum {
#define DEF_SURFACETYPE(name, st0, st1, flagsA, flagsB)                        \
  NIGHTCLUB_SCENE_COL_##name##_FLAGS_A = (flagsA),                            \
  NIGHTCLUB_SCENE_COL_##name##_FLAGS_B = (flagsB),
#include "../table_polytypes.h"
#undef DEF_SURFACETYPE
  NIGHTCLUB_SCENE_COL_FLAGS_LAST
};

enum {
#define DEF_SURFACETYPE(name, st0, st1, flagsA, flagsB)                        \
  NIGHTCLUB_SCENE_SURFACETYPE_##name,
#include "../table_polytypes.h"
#undef DEF_SURFACETYPE
  MY_MAP_SURFACETYPE_MAX
};

SurfaceType nightclub_scene_SurfaceTypes[] = {
#define DEF_SURFACETYPE(name, st0, st1, flagsA, flagsB) {{st0, st1}},
#include "../table_polytypes.h"
#undef DEF_SURFACETYPE
};

BgCamInfo nightclub_scene_BgCamList[] = {
...
TransitionActorEntry nightclub_scene_TransitionActorList[] = {
