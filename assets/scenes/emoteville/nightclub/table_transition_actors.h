...
/*
DEF_TRANSITION_ACTOR(NIGHTCLUB_SCENE_ROOM_ROOM_NAME,
                     NIGHTCLUB_SCENE_CAMERA_DEFAULT,
                     NIGHTCLUB_SCENE_ROOM_ROOM_NAME,
                     NIGHTCLUB_SCENE_CAMERA_DEFAULT, ACTOR_EN_DOOR, POS_DOOR0,
