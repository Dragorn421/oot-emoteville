...
DEFINE_OBJECT(object_emoji_door, OBJECT_EMOJI_DOOR)
DEFINE_OBJECT(object_emoji_rock, OBJECT_EMOJI_ROCK)
DEFINE_OBJECT(object_emoji_furniture, OBJECT_EMOJI_FURNITURE)
DEFINE_OBJECT(object_dancing, OBJECT_DANCING)
DEFINE_OBJECT(object_dragon, OBJECT_DRAGON)
DEFINE_OBJECT(object_nightclub, OBJECT_NIGHTCLUB)
