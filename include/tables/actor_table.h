...
DEFINE_ACTOR(ActorEmojiRock, ACTOR_EMOJI_ROCK, ACTOROVL_ALLOC_NORMAL, "emoji rock")
DEFINE_ACTOR(ActorEmojiDoor, ACTOR_EMOJI_DOOR, ACTOROVL_ALLOC_NORMAL, "emoji door")
DEFINE_ACTOR(ActorEmojiProp, ACTOR_EMOJI_PROP, ACTOROVL_ALLOC_NORMAL, "emoji prop")
DEFINE_ACTOR(ActorDancing, ACTOR_DANCING, ACTOROVL_ALLOC_NORMAL, "dancing")
DEFINE_ACTOR(ActorDragon, ACTOR_DRAGON, ACTOROVL_ALLOC_NORMAL, "dragon")
DEFINE_ACTOR(ActorDragonFire, ACTOR_DRAGON_FIRE, ACTOROVL_ALLOC_PERSISTENT, "dragon fire")
DEFINE_ACTOR(ActorNightclubCF, ACTOR_NIGHTCLUB_CEILING_FIXTURES, ACTOROVL_ALLOC_NORMAL, "nightclub CF")
